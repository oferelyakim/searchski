...
/**
 * The classic search page — one text box, chips, filters. Moved here from the
 * homepage when the interview took over as the front door; everything about it
 * is unchanged, and the interview links here as its escape hatch.
 *
